...
@dataclass
class Message:
    email = 'free2mmm@gmail.com'
    subject = 'Это тема письма'
    message = '''Lorem Ipsum - это текст-"рыба", часто используемый в
...
послужили публикация листов Letraset с образцами Lorem Ipsum в 60-х годах и,
